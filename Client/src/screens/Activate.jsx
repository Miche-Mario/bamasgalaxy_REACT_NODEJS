...
const Activate = ({ match }) => {
  ...
  return (
    ...
    <div style={{marginTop: '50px'}} className='min-h-screen bg-gray-100 text-gray-900 flex justify-center'>
      ...
      <div className='max-w-screen-xl m-0 sm:m-20 bg-white shadow sm:rounded-lg flex justify-center flex-1'>
        <div className='lg:w-1/2 xl:w-5/12 p-6 sm:p-12'>
          <div className='mt-12 flex flex-col items-center'>
            ...
            <div style={{marginBottom: '-40px'}} class="alert alert-success" role="alert">
              <h4 class="alert-heading">Plus qu'une dernière étape!</h4>
              <p>Merci d'activer votre compte en cliquant sur le bouton ci-dessous puis connecter vous avec vos identifiants</p>
              <hr/>
            </div>
            ...
            >
              <div className='mx-auto max-w-xs relative '>
                ...
                >
                  ...
                  <span className='ml-4 mr-4 '>Activer votre compte</span>
                </button>
              </div>
